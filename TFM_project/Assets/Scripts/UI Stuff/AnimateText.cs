...
namespace BitWave_Labs.AnimatedTextReveal
{
    ...
    public class AnimateText : MonoBehaviour
    {
        ...
        /// <summary>
        /// Automatically start the text sequence when the object becomes active.
        /// </summary>
        private void Start()
        {
            // Begin cycling automatically when the scene starts
        ...
        {
            // Wait 3 seconds before starting fade-in sequence
